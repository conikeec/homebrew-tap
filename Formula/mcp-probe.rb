class McpProbe < Formula
  ...
  if Hardware::CPU.intel?
    url "https://github.com/conikeec/mcp-probe/releases/download/v0.1.56/mcp-probe-x86_64-apple-darwin.tar.gz"
    sha256 "0019dfc4b32d63c1392aa264aed2253c1e0c2fb09216f8e2cc269bbfb8bb49b5"
  else
    url "https://github.com/conikeec/mcp-probe/releases/download/v0.1.56/mcp-probe-aarch64-apple-darwin.tar.gz"
